...
_G.packer_plugins = {
  ...
  harpoon = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/theprimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/markus/.local/share/nvim/site/pack/packer/start/playground",
